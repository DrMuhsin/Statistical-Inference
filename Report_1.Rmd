...
for (no_sim in c(10, 100, 1000, 10000)){
  ...
  myhist <- hist(mean_values , freq = TRUE, xlim = c(2, 8), 
                 main = paste("Histogram of", no_sim, "simulations"), xlab = "Values", col="green")
}
```
...
The simulation for 100 simulations was rerun and the confidence interval for each simulation was plotted for visualization purposes. 
```{r}
